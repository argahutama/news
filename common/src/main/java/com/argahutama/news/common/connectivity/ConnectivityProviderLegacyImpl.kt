...
import com.argahutama.news.common.connectivity.base.ConnectivityProvider.NetworkState.ConnectedState.ConnectedLegacy
...
class ConnectivityProviderLegacyImpl(
    ...
    override fun getNetworkState(): NetworkState {
        ...
        return if (activeNetworkInfo != null) ConnectedLegacy(activeNetworkInfo) else NotConnectedState
    }
