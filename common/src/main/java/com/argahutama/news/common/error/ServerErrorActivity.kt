...
import com.argahutama.news.common.databinding.ActivityServerErrorBinding
...
@AndroidEntryPoint
class ServerErrorActivity : BaseActivity<ErrorViewState>() {
    override val binding by lazy { ActivityServerErrorBinding.inflate(layoutInflater) }
